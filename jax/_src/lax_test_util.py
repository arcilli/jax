...
def lax_ops():
  return [
      op_record("neg", 1, default_dtypes + complex_dtypes, test_util.rand_small),
      ...
      # precision.
      op_record("expm1", 1, float_dtypes + complex_dtypes, test_util.rand_small,
                {np.float64: 1e-8}),
      op_record("log", 1, float_dtypes + complex_dtypes, test_util.rand_positive),
      op_record("log1p", 1, float_dtypes + complex_dtypes, test_util.rand_positive),
      # TODO(b/142975473): on CPU, tanh for complex128 is only accurate to
      # ~float32 precision.
      # TODO(b/143135720): on GPU, tanh has only ~float32 precision.
    op_record("tanh", 1, float_dtypes + complex_dtypes, test_util.rand_small,
              {np.float64: 1e-9, np.complex128: 1e-7}),
      op_record("logistic", 1, float_dtypes + complex_dtypes, test_util.rand_default),
      op_record("sin", 1, float_dtypes + complex_dtypes, test_util.rand_default),
      op_record("cos", 1, float_dtypes + complex_dtypes, test_util.rand_default),
    ...
    op_record("sqrt", 1, float_dtypes, test_util.rand_positive),
      ...
      op_record("square", 1, float_dtypes + complex_dtypes, test_util.rand_default),
      op_record("reciprocal", 1, float_dtypes + complex_dtypes, test_util.rand_positive),
      op_record("tan", 1, float_dtypes + complex_dtypes, test_util.rand_default, {np.float32: 3e-5}),
      op_record("asin", 1, float_dtypes + complex_dtypes, test_util.rand_small, {np.complex128: 5e-12}),
      ...
      op_record("asinh", 1, float_dtypes + complex_dtypes, test_util.rand_default,
                tol={np.complex64: 1E-4, np.complex128: 1E-5}),
      op_record("acosh", 1, float_dtypes + complex_dtypes, test_util.rand_positive),
      # TODO(b/155331781): atanh has only ~float precision
    op_record("atanh", 1, float_dtypes + complex_dtypes, test_util.rand_small, {np.float64: 1e-9}),
      op_record("sinh", 1, float_dtypes + complex_dtypes, test_util.rand_default),
      op_record("cosh", 1, float_dtypes + complex_dtypes, test_util.rand_default),
      op_record("lgamma", 1, float_dtypes, test_util.rand_positive,
                {np.float32: 1e-3 if test_util.device_under_test() == "tpu" else 1e-5,
                 np.float64: 1e-14}),
      op_record("digamma", 1, float_dtypes, test_util.rand_positive,
                {np.float64: 1e-14}),
      op_record("betainc", 3, float_dtypes, test_util.rand_positive,
                {np.float64: 1e-14}),
      op_record("igamma", 2,
                [f for f in float_dtypes if f not in [dtypes.bfloat16, np.float16]],
                test_util.rand_positive, {np.float64: 1e-14}),
      op_record("igammac", 2,
                [f for f in float_dtypes if f not in [dtypes.bfloat16, np.float16]],
                test_util.rand_positive, {np.float64: 1e-14}),
    ...
    op_record("erf_inv", 1, float_dtypes, test_util.rand_small,
              {np.float64: 1e-9}),
    ...
    op_record("real", 1, complex_dtypes, test_util.rand_default),
      ...
      op_record("abs", 1, default_dtypes + complex_dtypes, test_util.rand_default),
      op_record("pow", 2, float_dtypes + complex_dtypes, test_util.rand_positive),
    ...
    op_record("bitwise_and", 2, bool_dtypes, test_util.rand_small),
      ...
      op_record("population_count", 1, int_dtypes + uint_dtypes, test_util.rand_int),
      op_record("clz", 1, int_dtypes + uint_dtypes, test_util.rand_int),

    op_record("add", 2, default_dtypes + complex_dtypes, test_util.rand_small),
      op_record("sub", 2, default_dtypes + complex_dtypes, test_util.rand_small),
      op_record("mul", 2, default_dtypes + complex_dtypes, test_util.rand_small),
      op_record("div", 2, default_dtypes + complex_dtypes, test_util.rand_nonzero),
